...
export default function About() {
    return(
            <div className="md:w-1/2 w-full md:mt-24 md:mx-auto md:flex md:flex-col md:items-center px-12 pt-12 mb-0 ">
                    <h1 className="text-5xl font-bold text-center">Usimamizi wa Mitandao ya Kijamii</h1> 
                    <p className="mt-4 mb-4 text-3xl font-light text-center italic">
